...
Use your configured architect runners (defaults `poteto-judge`, `poteto-fable`, and `poteto-code`, one per available family). To add a genuinely foreign design voice, see [`../interrogate/references/external-reviewer.md`](../interrogate/references/external-reviewer.md).
